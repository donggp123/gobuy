...
<head>
    <style type="text/css">
        ...
        .order-settl-left{width:50%;height:160px;float: left;}
        .order-settl-right{width:50%;height:160px;float: left;position: relative;}
...
<div class="page-container">
    ...
    <div style="text-align: center;width:95%;margin: 0 auto;">
        <a href="javascript:;" onclick="settled('${settle.id}')" class="btn btn-primary radius size-M">结算</a>
    </div>
</div>
</body>
<script type="text/javascript">
    function settled(id) {
        layer.confirm('确定要结算吗？',function() {
            $.ajax({
                type: 'POST',
                url: '/settle/settle',
                data: {id: id},
