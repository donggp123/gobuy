...
<div class="page-container">
    <div class="text-c">
        <form action="/settle/list" method="post">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <td>
                    <c:if test="${s.settleStatus == 1 or s.settleStatus == 2}">
                        <a href="javascript:;" onclick="settle('${s.id}')" class="btn btn-primary radius size-M">结算</a>
                    </c:if>
                    <c:if test="${s.settleStatus == 3}">
...
<script type="text/javascript">
    ...
    function settle(id) {
        layer_show("结算信息", "/settle/toSettle?id=" + id, "1200", "650");
    }

    function view(id) {
        layer_show("结算信息", "/settle/view?id=" + id, "1200", "650");
    }
</script>
</html>
