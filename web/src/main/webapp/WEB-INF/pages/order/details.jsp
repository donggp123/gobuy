...
<div class="page-container">
    <div class="orderInfo">
        ...
        <div class="info">
            ...
            <div class="info-right">
                <div style="text-align: left;width: 200px;margin-left: 450px;">订单状态：
                ...
                <div style="text-align: left;width: 200px;margin-left: 450px;">订单金额：<span style="color: red;">¥ ${order.totalPrice}</span></div>
            </div>
        </div>
    </div>
    <div class="track">
    ...
    <div style="text-align: right;padding-right:40px;">
        ...
        <a href="/order/list" class="btn btn-primary radius size-M" style="background: #fff;color: red;border-color: #ccc;margin-top:10px;">关闭</a>
    </div>
